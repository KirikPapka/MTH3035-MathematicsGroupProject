      SUBROUTINE implicit_solver_flux_qv(chi,u,v,k_diff,z,zn,dt,r_kkp  &
                                      ,chi_inter,h_0)

      ! Subroutine to calculated turbulent diffusion 
      ! using an implicit method
      ! for applied surface latent heat flux.
      ...
      REAL, DIMENSION(kkp) :: dz_temp, dzn_temp      
...
! Explicit surface fluxes gamma=0 in h_n specification
      ...
      chi_inter(1) = H_n * dzn(2)/kh_1_neut   & 
                     + chi_inter(2)     
